...
\begin{figure}[H]
	...
	\label{fig:figure37}
\end{figure}
Next, is to edit the scenario outline, by changing the column and row amount, we can provide informations according to the requirement of the scenario outline.
\begin{figure}[H]
	\centering
